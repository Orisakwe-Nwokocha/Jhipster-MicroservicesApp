...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("dev.orisha.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("dev.orisha.security.DomainUserDetailsService", "createSpringSecurityUser");
