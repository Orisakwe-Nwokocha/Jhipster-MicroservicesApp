...
import dev.orisha.config.Constants;
import dev.orisha.domain.User;
import dev.orisha.repository.UserRepository;
import dev.orisha.security.AuthoritiesConstants;
import dev.orisha.service.MailService;
import dev.orisha.service.UserService;
import dev.orisha.service.dto.AdminUserDTO;
import dev.orisha.web.rest.errors.BadRequestAlertException;
import dev.orisha.web.rest.errors.EmailAlreadyUsedException;
import dev.orisha.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link dev.orisha.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
